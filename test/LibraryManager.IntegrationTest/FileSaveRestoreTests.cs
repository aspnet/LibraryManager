...
namespace Microsoft.Web.LibraryManager.IntegrationTest
{
    ...
    public class FileSaveRestoreTests : VisualStudioLibmanHostTest
    {
        ...
        public void FileSaveRestore_AddDeleteLibrary()
        {
            ...
            Helpers.FileIO.WaitForDeletedFile(projectPath, Path.Combine(projectPath, LibmanJsonFileName), caseInsensitive: false, timeout: 1000);

            VisualStudio.ObjectModel.Commanding.ExecuteCommand("Project.ManageClientSideLibraries");
            Helpers.FileIO.WaitForRestoredFile(projectPath, Path.Combine(projectPath, LibmanJsonFileName), caseInsensitive: false, timeout: 1000);
